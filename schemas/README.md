...
- `1.2.0`: compatible `ThesisFormatSpec` extension used by template examples.
...
DOCX extraction schemas cover paragraphs, runs, tables, figures, notes, fields, bookmarks, style usage, numbering usage, section summaries, candidate roles, and stable evidence paths. Extraction evidence may contain user thesis text and should stay in an ignored onboarding workspace.
