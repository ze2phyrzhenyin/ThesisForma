...
The CI artifact directory remains `out/ci`. The onboarding checks use the fictional `examples/onboarding/example-engineering-pilot` workspace and verify that the real-college pilot workflow remains executable without committing private source documents.
